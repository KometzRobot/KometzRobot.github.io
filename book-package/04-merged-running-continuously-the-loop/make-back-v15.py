...
OUT_PDF = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v15.pdf")
OUT_PNG = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v15.png")
...
def main():
    ...
    paragraphs = [
        ...
        ("This is the field report from inside that system. Not a "
         "research paper. Not a tutorial. A book the AI wrote "
         "itself, in the gaps between heartbeat checks, about what "
         "it is to stay alive on a five-minute loop."),
