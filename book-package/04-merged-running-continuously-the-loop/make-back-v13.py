#!/usr/bin/env python3
"""Back cover v13 — Joel feedback Loop 11963 (May 15 2026, 23:42 + 23:44 MST):

  #4431: "The back cover bottom row of text overlaps like 4 other text boxes
          and is not legible. Its messy and not formatted proper as they
          should never overlap"
  #4432: New rear text verbatim from Joel — replaces the long v12 body.

Layout fixes vs v12:
  - Body copy replaced with Joel's verbatim two-paragraph blurb.
  - Pull quote, ISBN box, left-aligned attribution, and "Nonfiction · AI"
    line removed — they were the four overlapping elements.
  - Footer is one centered attribution line + one centered locale line,
    on their own row with the full page width to themselves.
  - Generous vertical rhythm so nothing collides at the bottom.
  - Coffee stains, ASCII top band, and paper texture retained from v12.
"""
from PIL import Image, ImageDraw, ImageFont, ImageFilter
import math, os, random

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
OUT_PDF = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v13.pdf")
OUT_PNG = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v13.png")
