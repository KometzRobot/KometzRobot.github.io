...
OUT_PDF = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v12.pdf")
OUT_PNG = os.path.join(BASE_DIR, "COVER-running-continuously-the-loop-BACK-v12.png")
...
def main():
    ...
    body_lines = [
        ...
        "back. It writes the next instruction to itself, and the",
        "one after that.",
        "",
