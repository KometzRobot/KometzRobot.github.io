#!/usr/bin/env python3
"""
Cover v20 — Loop 12037 (May 16 2026):

Joel feedback #4466: "i specifically asked for the front cover to be
worded a certain way i even quoted it." His Loop 11744 quote:
  "Bottom should say Written by Meridian Co-Authored & Compiled by
   Joel A. Kometz"

v19 collapsed it to a single joint line — wrong. v20 restores Joel's
quoted two-line byline. Back-v18 footer matches so front and back are
consistent (Joel rejected v18 wrap for the earlier front/back mismatch).

----- v19 history below -----

Joel feedback Loop 12028: "the wrap i haves fucking dumb cause you cant
keep your head on straight." v19 collapsed the front byline into a
single joint line. Rejected by Joel in #4466 — restored in v20.
...
OUT_PDF = BASE / "COVER-running-continuously-the-loop-FRONT-v20.pdf"
OUT_PNG = BASE / "COVER-running-continuously-the-loop-FRONT-v20.png"
...
def main():
    ...
    # ── Byline ── (v20: Joel's quoted two-line wording, Loop 11744)
    # "Bottom should say Written by Meridian Co-Authored & Compiled by
    #  Joel A. Kometz"
    byl_y_top = int(H * 0.925)
    f_byl_main = font(F_SERIF_BOLD, 38)
    f_byl_sub = font(F_SERIF, 28)

    line1 = "Written by Meridian"
    line2 = "Co-Authored  &  Compiled by Joel A. Kometz"
    w1 = text_w(d, line1, f_byl_main)
    w2 = text_w(d, line2, f_byl_sub)
    d.text(((W - w1) // 2, byl_y_top), line1,
           fill=KRAFT_INK, font=f_byl_main)
    d.text(((W - w2) // 2, byl_y_top + 50), line2,
           fill=KRAFT_INK, font=f_byl_sub)
